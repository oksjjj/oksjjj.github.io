...
>
> 로그를 취하면 $log(AB) = log A + log B$가 되므로  
...
> 
> 이 페이지에서는 앞서 언급한 것처럼  
> $log$를 취하고 싶다는 내용을 실제로 반영한 식을 설명하고 있습니다.  
>
...
> 실제로는 $q$가 Gaussian distribution임)*  
>
> 그래서 $T$라는 변환을 통해  
...
>
> 이렇게 fully connected layer 형태의 플로우를 사용하면  
> 자코비안을 구할 수 있고  
